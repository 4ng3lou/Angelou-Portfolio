...
const full: Record<string, { icon: string; items: string[] }> = {
  "Frontend Development": { icon: "", items: ["HTML", "CSS", "React", "Next.js 15", "TypeScript", "Tailwind CSS v4", "React Native + Expo", "UI/UX Design", "Framer Motion"] },
  "Backend Development": { icon: "", items: ["Node.js", "Next.js API Routes", "Python", "Laravel (PHP)", "C++", "C#", "Java", "REST / GraphQL", "Zod (Validation)", "Better Auth"] },
